...
{{with purchase}}
    ...
    <form class="my-4 bg-white p-8 rounded shadow-lg mx-auto max-w-md" action="index.php?page=Purchases_Purchases&mode={{~mode}}&id_purchase={{id}}" method="POST"><input type="hidden" name="xss_token_purchase" value="{{~xss_token_purchase}}"/><section class="mb-4">
