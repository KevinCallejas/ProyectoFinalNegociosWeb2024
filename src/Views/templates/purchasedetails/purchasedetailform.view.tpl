...
{{with purchasedetail}}
    ...
    <form class="my-4 bg-white p-8 rounded shadow-lg mx-auto max-w-md" action="index.php?page=Purchasedetails_Purchasedetails&mode={{~mode}}&id_purchase={{id}}" method="POST"><input type="hidden" name="xss_token_purchasedetail" value="{{~xss_token_purchasedetail}}"/><section class="mb-4">
