...
{{with products}}
    ...
    <form class="my-4 bg-white p-8 rounded shadow-lg mx-auto max-w-md" action="index.php?page=Productss_Productss&mode={{~mode}}&productId={{id}}" method="POST"><input type="hidden" name="xss_token_products" value="{{~xss_token_products}}"/><section class="mb-4">
